...
#define STRING_CONFIG_H_AUTHOR "(Greg, TEVO Flash bugfix-2.0.x)" // Who made the changes.
...
#define MIXING_EXTRUDER
  ...
  #define MIXING_VIRTUAL_TOOLS 5  // Use the Virtual Tool method with M163 and M164
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  22.45,  22.45 }
    #define DEFAULT_Ki_LIST {   1.70,   1.70 }
    #define DEFAULT_Kd_LIST {  74.15,  74.15 }
  #else
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160.1, 160.1, 800, 808 }
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS + 0), (Y_MAX_POS - 10), 20 }
